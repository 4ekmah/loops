...
namespace loops
{
    enum {
        ...
        INTEL64_VROUNDPS    =  87,
        INTEL64_VROUNDPD    =  88,
        INTEL64_VCVTPS2DQ   =  89,
        INTEL64_VCVTPD2DQ   =  90,
        INTEL64_VCVTDQ2PS   =  91,
        INTEL64_VPMOVSXDQ   =  92,
        INTEL64_JMP         =  93,
        INTEL64_JNE         =  94, //TODO(ch)[printer]: implement JCC operation instead of this endless variations.
        INTEL64_JE          =  95,
        INTEL64_JL          =  96,
        INTEL64_JLE         =  97,
        INTEL64_JG          =  98,
