...
namespace loops
{
    enum {
        ...
        INTEL64_VCMPLTPD    =  85,
        INTEL64_VCMPLEPD    =  86,
        INTEL64_VPBLENDVB   =  87,
        INTEL64_VBLENDVPS   =  88,
        INTEL64_VBLENDVPD   =  89,
        INTEL64_VPAND       =  90,
        INTEL64_VPOR        =  91,
        INTEL64_VPXOR       =  92,
        INTEL64_VPSLLW      =  93,
        ...
        INTEL64_VPSRLVD     = 104,
        INTEL64_VPSRLVQ     = 105,
        INTEL64_VROUNDPS    = 106,
        INTEL64_VROUNDPD    = 107,
        INTEL64_VCVTPS2DQ   = 108,
        INTEL64_VCVTPD2DQ   = 109,
        INTEL64_VCVTDQ2PS   = 110,
        INTEL64_VPMOVSXDQ   = 111,
        INTEL64_JMP         = 112,
        INTEL64_JNE         = 113, //TODO(ch)[printer]: implement JCC operation instead of this endless variations.
        INTEL64_JE          = 114,
        INTEL64_JL          = 115,
        INTEL64_JLE         = 116,
        INTEL64_JG          = 117,
