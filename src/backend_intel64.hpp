...
namespace loops
{
    enum {
        ...
        INTEL64_VMOVD        =  52,
        INTEL64_VMOVQ        =  53,
        INTEL64_VPBROADCASTB =  54,
        INTEL64_VPBROADCASTW =  55,
        INTEL64_VPBROADCASTD =  56,
        INTEL64_VPBROADCASTQ =  57,
        INTEL64_VPADDB       =  58,
        INTEL64_VPADDW       =  59,
        INTEL64_VPADDD       =  60,
        INTEL64_VPADDQ       =  61,
        ...
        INTEL64_VDIVPS       =  74,
        INTEL64_VDIVPD       =  75,
        INTEL64_VFMADD231PS  =  76,
        INTEL64_VFMADD231PD  =  77,
        INTEL64_VPMINUB      =  78,
        INTEL64_VPMINSB      =  79,
        INTEL64_VPMINUW      =  80,
        INTEL64_VPMINSW      =  81,
        ...
        INTEL64_VPCMPGTB     =  98,
        INTEL64_VPCMPGTW     =  99,
        INTEL64_VPCMPGTD     = 100,
        INTEL64_VPCMPGTQ     = 101,
        INTEL64_VCMPEQPS     = 102,
        INTEL64_VCMPNEQPS    = 103,
        INTEL64_VCMPLTPS     = 104,
        INTEL64_VCMPLEPS     = 105,
        INTEL64_VCMPEQPD     = 106,
        INTEL64_VCMPNEQPD    = 107,
        INTEL64_VCMPLTPD     = 108,
        INTEL64_VCMPLEPD     = 109,
        INTEL64_VPBLENDVB    = 110,
        INTEL64_VBLENDVPS    = 111,
        INTEL64_VBLENDVPD    = 112,
        INTEL64_VPAND        = 113,
        INTEL64_VPOR         = 114,
        INTEL64_VPXOR        = 115,
        INTEL64_VPSLLW       = 116,
        ...
        INTEL64_VPSRLVD      = 127,
        INTEL64_VPSRLVQ      = 128,
        INTEL64_VROUNDPS     = 129,
        INTEL64_VROUNDPD     = 130,
        INTEL64_VCVTPS2DQ    = 131,
        INTEL64_VCVTPD2DQ    = 132,
        INTEL64_VCVTDQ2PS    = 133,
        INTEL64_VPMOVSXBW    = 134,
        INTEL64_VPMOVSXWD    = 135,
        INTEL64_VPMOVSXDQ    = 136,
        INTEL64_VPMOVZXBW    = 137,
        INTEL64_VPMOVZXWD    = 138,
