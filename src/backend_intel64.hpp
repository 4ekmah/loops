...
namespace loops
{
    enum {
        ...
        INTEL64_VMULPS      = 45,
        INTEL64_VMULPD      = 46,
        INTEL64_VFMADD231PS = 47,
        INTEL64_VFMADD231PD = 48,
        INTEL64_VPMINUB     = 49,
        INTEL64_VPMINSB     = 50,
        INTEL64_VPMINUW     = 51,
        INTEL64_VPMINSW     = 52,
        ...
        INTEL64_VROUNDPS    = 78,
        INTEL64_VROUNDPD    = 79,
        INTEL64_VCVTPS2DQ   = 80,
        INTEL64_VCVTPD2DQ   = 81,
        INTEL64_VCVTDQ2PS   = 82,
        INTEL64_VPMOVSXDQ   = 83,
        INTEL64_JMP         = 84,
        INTEL64_JNE         = 85, //TODO(ch)[printer]: implement JCC operation instead of this endless variations.
        INTEL64_JE          = 86,
        INTEL64_JL          = 87,
        INTEL64_JLE         = 88,
        INTEL64_JG          = 89,
