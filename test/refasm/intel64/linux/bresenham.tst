bresenham(i0, i1, i2, i3, i4, i5, i6)
    ...
    20 : mov   [rsp+#0x28], r13 ; 4c 89 6c 24 28              
    21 : mov   r12, r9          ; 4d 89 cc                    
    22 : sub   r12, rcx         ; 49 29 cc                    
    23 : mov   [rsp], r12       ; 4c 89 64 24 00              
    24 : neg   r12              ; 49 f7 dc                    
    25 : cmovs r12, [rsp]       ; 4c 0f 48 a4 24 00 00 00 00  
    26 : mov   [rsp+#0x30], r12 ; 4c 89 64 24 30              
    27 : neg   [rsp+#0x30]      ; 48 f7 5c 24 30              
    28 : mov   r12, r9          ; 4d 89 cc                    
    29 : sub   r12, rcx         ; 49 29 cc                    
    30 : mov   [rsp], rcx       ; 48 89 4c 24 00              
