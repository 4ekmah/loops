arithm_arrs(i0, i1, i2, i3, i4, i5, i6)
     ...
     4 : mov    [rsp+#0x28], #0    ; 48 c7 44 24 28 00 00 00 00           
     5 : mov    [rsp+#0x20], #0    ; 48 c7 44 24 20 00 00 00 00           
     6 : cmp    [rsp+#0x20], rdx   ; 48 39 94 24 20 00 00 00              
     7 : jge    [39]               ; 0f 8d ad 00 00 00                    
