all_loads_all_stores(i0, i1, i2, i3, i4)
    ...
    30 : cmp    [rsp+#0x10], r8    ; 4c 39 84 24 10 00 00 00              
    31 : jge    [121]              ; 0f 8d e8 01 00 00                    
    ...
    36 : movzx  rax, dil, r13      ; 4a 0f b6 04 2f                       
    37 : mov    r12, rax           ; 49 89 c4                             
    ...
    42 : movsx  rax, dil, r13      ; 4a 0f be 04 2f                       
    43 : mov    r12, rax           ; 49 89 c4                             
    ...
    48 : movzx  rax, di, r13       ; 4a 0f b7 04 2f                       
    49 : mov    r12, rax           ; 49 89 c4                             
    ...
    54 : movsx  rax, di, r13       ; 4a 0f bf 04 2f                       
    55 : mov    r12, rax           ; 49 89 c4                             
    ...
    60 : mov    eax, [rdi], [r13]  ; 42 8b 04 2f                          
    61 : mov    r12, rax           ; 49 89 c4                             
    ...
    66 : movsxd rax, rdi, r13      ; 4a 63 04 2f                          
    67 : mov    r12, rax           ; 49 89 c4                             
    ...
    72 : mov    rax, [rdi], [r13]  ; 4a 8b 04 2f                          
    73 : mov    r12, rax           ; 49 89 c4                             
    74 : jmp    [78]               ; e9 0f 00 00 00                       
    75 : mov    r13, [rsp+#0x08]   ; 4c 8b ac 24 08 00 00 00              
    76 : mov    rax, [rdi], [r13]  ; 4a 8b 04 2f                          
    77 : mov    r12, rax           ; 49 89 c4                             
   ...
   116 : add    [rsp+#0x08], r13   ; 4c 01 ac 24 08 00 00 00              
   117 : mov    r13, [rsp+#0x20]   ; 4c 8b ac 24 20 00 00 00              
   118 : add    [rsp], r13         ; 4c 01 ac 24 00 00 00 00              
   119 : add    [rsp+#0x10], #0x01 ; 48 81 84 24 10 00 00 00 01 00 00 00  
   120 : jmp    [30]               ; e9 0a fe ff ff                       
   121 : mov    r12, [rsp+#0x28]   ; 4c 8b a4 24 28 00 00 00              
   122 : mov    r13, [rsp+#0x30]   ; 4c 8b ac 24 30 00 00 00              
