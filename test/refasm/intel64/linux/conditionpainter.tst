conditionpainter(i0)
     ...
     1 : mov    [rsp+#0x28], rdi                 ; 48 89 bc 24 28 00 00 00              
     2 : mov    [rsp+#0x40], r12                 ; 4c 89 a4 24 40 00 00 00              
     3 : mov    [rsp+#0x48], r13                 ; 4c 89 ac 24 48 00 00 00              
     4 : mov    r13, #0xfffffffffffffffb         ; 49 c7 c5 fb ff ff ff                 
     5 : mov    [rsp+#0x20], r13                 ; 4c 89 ac 24 20 00 00 00              
     6 : cmp    [rsp+#0x20], #0x05               ; 48 81 bc 24 20 00 00 00 05 00 00 00  
    ...
    14 : mov    [rsp+#0x38], r13                 ; 4c 89 ac 24 38 00 00 00              
    15 : mov    r13, #0xfffffffffffffffb         ; 49 c7 c5 fb ff ff ff                 
    16 : mov    [rsp+#0x30], r13                 ; 4c 89 ac 24 30 00 00 00              
    17 : cmp    [rsp+#0x30], #0x05               ; 48 81 bc 24 30 00 00 00 05 00 00 00  
    18 : jg     [138]                            ; 0f 8f 88 02 00 00                    
    19 : mov    r13, [rsp+#0x30]                 ; 4c 8b ac 24 30 00 00 00              
    20 : mov    rax, r13                         ; 4c 89 e8                             
    21 : add    rax, #0x03                       ; 48 05 03 00 00 00                    
    22 : xor    r12, r12                         ; 4d 31 e4                             
    23 : cmp    [rsp+#0x20], rax                 ; 48 39 84 24 20 00 00 00              
    24 : setge  r12                              ; 41 0f 9d c4                          
    25 : xor    rax, rax                         ; 48 31 c0                             
    26 : cmp    [rsp+#0x20], #0x04               ; 48 81 bc 24 20 00 00 00 04 00 00 00  
    27 : setle  rax                              ; 0f 9e c0                             
    28 : and    r12, rax                         ; 49 21 c4                             
    29 : xor    rax, rax                         ; 48 31 c0                             
    30 : cmp    [rsp+#0x30], #0xfffffffffffffffe ; 48 81 bc 24 30 00 00 00 fe ff ff ff  
    ...
    41 : cmp    [rsp+#0x20], rax                 ; 48 39 84 24 20 00 00 00              
    ...
    53 : imul   rax, [rsp+#0x30]                 ; 48 0f af 84 24 30 00 00 00           
    54 : mov    r13, [rsp+#0x20]                 ; 4c 8b ac 24 20 00 00 00              
    55 : mov    rdi, r13                         ; 4c 89 ef                             
    56 : imul   rdi, [rsp+#0x20]                 ; 48 0f af bc 24 20 00 00 00           
    ...
    82 : imul   rdx, [rsp+#0x30]                 ; 48 0f af 94 24 30 00 00 00           
    83 : mov    r13, [rsp+#0x20]                 ; 4c 8b ac 24 20 00 00 00              
    84 : mov    rcx, r13                         ; 4c 89 e9                             
    85 : imul   rcx, [rsp+#0x20]                 ; 48 0f af 8c 24 20 00 00 00           
   ...
   130 : mov    r13, [rsp+#0x30]                 ; 4c 8b ac 24 30 00 00 00              
   ...
   136 : add    [rsp+#0x30], #0x01               ; 48 81 84 24 30 00 00 00 01 00 00 00  
   137 : jmp    [17]                             ; e9 66 fd ff ff                       
   138 : add    [rsp+#0x20], #0x01               ; 48 81 84 24 20 00 00 00 01 00 00 00  
   139 : jmp    [6]                              ; e9 0f fd ff ff                       
   140 : mov    r12, [rsp+#0x40]                 ; 4c 8b a4 24 40 00 00 00              
   141 : mov    r13, [rsp+#0x48]                 ; 4c 8b ac 24 48 00 00 00              
   142 : add    rsp, #0x58                       ; 48 81 c4 58 00 00 00                 
   143 : ret                                     ; c3                                   
