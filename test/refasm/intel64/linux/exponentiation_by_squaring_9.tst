exponentiation_by_squaring_9(i0, i1, i2)
     ...
     5 : cmp    [rsp], rsi       ; 48 39 74 24 00              
     6 : jge    [19]             ; 0f 8d 2f 00 00 00           
    ...
    14 : mov    [rdx], eax       ; 89 02                       
    15 : add    [rsp], #0x01     ; 48 83 44 24 00 01           
    16 : add    rcx, #0x04       ; 48 83 c1 04                 
    17 : add    rdx, #0x04       ; 48 83 c2 04                 
    18 : jmp    [5]              ; e9 c6 ff ff ff              
