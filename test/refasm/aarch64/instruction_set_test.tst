instruction_set_test()
   ...
   445 : scvtf  v0.8h, v0.8h                  ; 00 d8 79 4e  
   446 : scvtf  v31.8h, v0.8h                 ; 1f d8 79 4e  
   447 : scvtf  v0.8h, v31.8h                 ; e0 db 79 4e  
   448 : scvtf  v0.4s, v0.4s                  ; 00 d8 21 4e  
   449 : scvtf  v31.4s, v0.4s                 ; 1f d8 21 4e  
   450 : scvtf  v0.4s, v31.4s                 ; e0 db 21 4e  
   451 : scvtf  v0.2d, v0.2d                  ; 00 d8 61 4e  
   452 : scvtf  v31.2d, v0.2d                 ; 1f d8 61 4e  
   453 : scvtf  v0.2d, v31.2d                 ; e0 db 61 4e  
   454 : ucvtf  v0.8h, v0.8h                  ; 00 d8 79 6e  
   455 : ucvtf  v31.8h, v0.8h                 ; 1f d8 79 6e  
   456 : ucvtf  v0.8h, v31.8h                 ; e0 db 79 6e  
   457 : ucvtf  v0.4s, v0.4s                  ; 00 d8 21 6e  
   458 : ucvtf  v31.4s, v0.4s                 ; 1f d8 21 6e  
   459 : ucvtf  v0.4s, v31.4s                 ; e0 db 21 6e  
   460 : ucvtf  v0.2d, v0.2d                  ; 00 d8 61 6e  
   461 : ucvtf  v31.2d, v0.2d                 ; 1f d8 61 6e  
   462 : ucvtf  v0.2d, v31.2d                 ; e0 db 61 6e  
   463 : fcvtms v0.8h, v0.8h                  ; 00 b8 79 4e  
   464 : fcvtms v31.8h, v0.8h                 ; 1f b8 79 4e  
   465 : fcvtms v0.8h, v31.8h                 ; e0 bb 79 4e  
   466 : fcvtms v0.4s, v0.4s                  ; 00 b8 21 4e  
   467 : fcvtms v31.4s, v0.4s                 ; 1f b8 21 4e  
   468 : fcvtms v0.4s, v31.4s                 ; e0 bb 21 4e  
   469 : fcvtms v0.2d, v0.2d                  ; 00 b8 61 4e  
   470 : fcvtms v31.2d, v0.2d                 ; 1f b8 61 4e  
   471 : fcvtms v0.2d, v31.2d                 ; e0 bb 61 4e  
   472 : fcvtmu v0.8h, v0.8h                  ; 00 b8 79 6e  
   473 : fcvtmu v31.8h, v0.8h                 ; 1f b8 79 6e  
   474 : fcvtmu v0.8h, v31.8h                 ; e0 bb 79 6e  
   475 : fcvtmu v0.4s, v0.4s                  ; 00 b8 21 6e  
   476 : fcvtmu v31.4s, v0.4s                 ; 1f b8 21 6e  
   477 : fcvtmu v0.4s, v31.4s                 ; e0 bb 21 6e  
   478 : fcvtmu v0.2d, v0.2d                  ; 00 b8 61 6e  
   479 : fcvtmu v31.2d, v0.2d                 ; 1f b8 61 6e  
   480 : fcvtmu v0.2d, v31.2d                 ; e0 bb 61 6e  
