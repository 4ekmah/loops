erode_msb_lsb(i0, i1, i2)
    ...
    16 : mov x3, x3         ; e3 03 03 aa  
    17 : eor x3, x3, x0     ; 63 00 00 ca  
    18 : str x3, [x2], #0   ; 43 00 00 f9  
    19 : sub x2, x0, #0x01  ; 02 04 00 d1  
    20 : mvn x2, x2         ; e2 03 22 aa  
    21 : and x2, x0, x2     ; 02 00 02 8a  
    22 : eor x0, x2, x0     ; 40 00 00 ca  
    23 : str x0, [x1], #0   ; 20 00 00 f9  
    24 : ldr x18, [sp], #0  ; f2 03 40 f9  
    25 : add sp, sp, #0x10  ; ff 43 00 91  
    26 : ret x30            ; c0 03 5f d6  
