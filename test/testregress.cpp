...
int main(int argc, char** argv)
{
    ...
    ::testing::GTEST_FLAG(filter) = "riscV.instruction_set_test:basic.a_plus_b:basic.min_max_scalar:basic.triangle_types:basic.ten_args_to_sum:basic.nonnegative_odd"; //DUBUG: return original line.
